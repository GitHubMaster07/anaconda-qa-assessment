...
Expected: "Email: test-1777179114095-9sf37y@example.com"
Received: "Email: "
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('#emailDisplay')
    7 × locator resolved to <p id="emailDisplay">Email: test-1777179114095-ibgdq2@example.com</p>
      - unexpected value "Email: test-1777179114095-ibgdq2@example.com"
    2 × locator resolved to <p id="emailDisplay">Email: </p>
